...
export const goalsApi = {
  saveGoal: (payload) => ApiService.post('/goals/save', payload),
  getActiveGoal: (userId) => ApiService.get(`/goals/active/${userId}`),
  getAllGoals: (userId) => ApiService.get(`/goals/all/${userId}`),
};

export const workoutsApi = {
  generateWorkout: (payload) => LongTimeoutApiService.post('/workouts/generate', payload),
  getHistory: (userId) => ApiService.get(`/workouts/history/${userId}`),
};
